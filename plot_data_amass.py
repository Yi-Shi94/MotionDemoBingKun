...
def get_data_from_dataset():
    config_file = 'config/model/amdm_amass_single.yaml'
    ...
    print("joint:")
    plot_util.plot_amass(data_frames_jnts_position0, dataset.links)
    ...
    print("vel:")
    plot_util.plot_amass(data_frames_jnts_position2, dataset.links)
    ...
    print("fk:")
    plot_util.plot_amass(data_frames_jnts_position1, dataset.links)
    ...
    print("ikfk:")
    plot_util.plot_amass(data_frames_jnts_position3, dataset.links)
    ...
    plot_util.plot_amass(jnt_pos, links, colors=colors) # 骨骼结构 dataset.util.skeleton_info.py
