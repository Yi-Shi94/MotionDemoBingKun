...
class Sample(base_command.BaseCommandTask):
    NAME = "Sample"
    def __init__(self, test_config):
        super(Sample).__init__()
    ...
    def play(self):
        seqs = self.model.eval_seq(self.init_frame, self.extra_dict, self.test_num_steps, self.test_num_trials)
